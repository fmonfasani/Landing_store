        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-600 hover:text-gray-900 font-medium transition-colors">Productos</a>
              <a href="#" className="text-gray-600 hover:text-gray-900 font-medium transition-colors">Ofertas</a>
              <a href="#" className="text-gray-600 hover:text-gray-900 font-medium transition-colors">Soporte</a>
            </nav>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <Button variant="outline" size="icon" className="relative hover:bg-gray-50">
                  ...
                  {cartItems > 0 && (
                    <Badge className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs bg-gradient-to-r from-blue-600 to-purple-600">
                      {cartItems}
                    </Badge>
                  )}
                </Button>
        ...
        <div className="relative container mx-auto px-4 py-24 md:py-32">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-gray-900 hover:bg-gray-100 text-lg px-8 py-4 h-auto font-semibold">
                🚀 Ver Ofertas Especiales
              </Button>
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-gray-900 text-lg px-8 py-4 h-auto font-semibold">
                📱 Explorar Catálogo
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4 mt-6">
                ...
                <div className="w-10 h-10 bg-gradient-to-r from-pink-500 to-red-500 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity cursor-pointer">
            ...
            <div>
              <h5 className="font-semibold text-lg mb-6">Atención al Cliente</h5>
              <ul className="space-y-3 text-gray-400">
                <li className="hover:text-white transition-colors cursor-pointer">📞 Contacto</li>
                <li className="hover:text-white transition-colors cursor-pointer">❓ FAQ</li>
                <li className="hover:text-white transition-colors cursor-pointer">🛠️ Soporte Técnico</li>
                <li className="hover:text-white transition-colors cursor-pointer">💬 Chat en Vivo</li>
              </ul>
            </div>
            <div>
              <h5 className="font-semibold text-lg mb-6">Información Legal</h5>
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="hover:text-white transition-colors cursor-pointer">↩️ Devoluciones</li>
                <li className="hover:text-white transition-colors cursor-pointer">🚚 Envíos</li>
              </ul>
            </div>
          </div>
